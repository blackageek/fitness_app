...
class DashboardCardioQuad extends StatefulWidget {
  const DashboardCardioQuad({super.key});

  @override
  State<DashboardCardioQuad> createState() => _DashboardCardioQuadState();
}

class _DashboardCardioQuadState extends State<DashboardCardioQuad> {
  ...
  Widget build(BuildContext context) {
    final nextExerciseIndex = _currentDay < _daysCompleted.length ? _currentDay : -1;
              ...
              child: FadeInAnimation(
                child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    ...
                    Center(child: TextComponent(text: "Tableau de bord du CardioQuard",size: 15,fontWeight: FontWeight.bold,)),
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Center(
                            child: TextComponent(
                              text: objectif.replaceAll(RegExp(r' *\(hommes\)| *\(Femmes\)'), '').trim(),
                              color: Colors.white.withOpacity(0.8),
                              fontWeight: FontWeight.bold,
                              size: 14,
                            ),
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      decoration: BoxDecoration(
                                        image: DecorationImage(
                                          image: AssetImage("assets/images/poids.png"),
                                        ),
                                      ),
                                    ),
                                    SizedBox(height: 5),
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      decoration: BoxDecoration(
                                        image: DecorationImage(
                                          image: AssetImage("assets/images/seance.png"),
                                        ),
                                      ),
                                    ),
                                    SizedBox(height: 5),
                    ...
                    Column(spacing: 10,
                      children: [
                        Center(child: TextComponent(text: "Menu du CardioQuad", fontWeight: FontWeight.bold,size: 14,color: mainColor,)),
                        OwnDivider(),
                      ],
                    ),
                    h(10),
                    Center(
                      child: Wrap(
                        ...
                        children: [
                          InkWell(
                              onTap : (){
                                Navigator.push(context, MaterialPageRoute(builder: (context) => Details(producName: "Le Stepper", path: "stepper1.png")));
                              },
                              child: BoxProduitG("quardio1.png", "Présentations","Le QuardioQuad")),
                          InkWell(
                              onTap: () {
                                Navigator.push(context, MaterialPageRoute(builder: (context) => BibliothequeCardioQuad(isFromAccueil: false,)));
                              },
                              child: BoxProduitD("quardio2.png", "Exercices avec le QuardioQuad","Le QuardioQuad")),
                          InkWell(
                              onTap : (){
                                Navigator.push(context, MaterialPageRoute(builder: (context) => ProgrammeCardio(isFromAccueil: false,)));
                              },
                              child: BoxProduitG("quardio3.png", "Programme d'entrainement","Le QuardioQuad")),
                          InkWell(
                              onTap : (){
                                Navigator.push(context, MaterialPageRoute(builder: (context) => Accueil(nom: 'Cardio Quad',)));
                              },
                              child: BoxProduitD("quardio4.png", "Séance Personnalisée","Le QuardioQuad")),
                        ],
                      ),
                    ),
                      ...
                      onTap: () {
                        ...
                        if (!joursSemaine.contains(today)) {
                          ...
                          Navigator.push(context,MaterialPageRoute(builder: (context) =>
                              objectif=="Perte de poids (hommes)"?PerteDePoidsHomme(isReturningFromDetails: false,joursSemaine: joursSemaine,):
                              objectif=="Développer la poitrine (hommes)"?PoitrineHomme(isReturningFromDetails: false,joursSemaine: joursSemaine,):
                              objectif=="Ventre plat et abdos définis (hommes)"?VentrePlatEtAbdosHomme(isReturningFromDetails: false,joursSemaine: joursSemaine,):
                              objectif=="Renforcement musculaire"?Renforcement(isReturningFromDetails: false,joursSemaine: joursSemaine,):
                              objectif=="Soulager les douleurs lombaires"?DouleurLombaire(isReturningFromDetails: false,joursSemaine: joursSemaine,):
                              objectif=="Routine corps complet"?RoutineCorpsComplet(isReturningFromDetails: false,joursSemaine: joursSemaine,):
                              objectif=="Ventre plat et abdos définis (Femmes)"?VentrePlatEtAbdosFemme(isReturningFromDetails: false,joursSemaine: joursSemaine,):
                              objectif=="Perte de graisse dans les bras (Femmes)"?PerteDeGraisseBras(isReturningFromDetails: false,joursSemaine: joursSemaine,):
                              CuisseJambeFessier(isReturningFromDetails: false,joursSemaine: joursSemaine,)
                          ));
                        }
                      },
                      child: Card(
                          ...
                          children: [
                                ...
                                Container(
                                  ...
                                  child:  Column(
                                    ...
                                    children: [
                                      ...
                                      TextComponent(text: jourSeance, fontWeight: FontWeight.bold,size: 13,textAlign: TextAlign.center,color: mainColor,),
                                    ],
                                  ),
                                ),
                                Expanded(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Container(
                                          ...
                                          child: Center(
                                            child: TextComponent(text: "${nbrManque.toInt()}",size: 14,fontWeight: FontWeight.bold,),
                                          ),
                                        ),
                                        TextComponent(text: "Manquées", fontWeight: FontWeight.bold,size: 13,color: Colors.black.withOpacity(0.7),),
                                      ],
                                    ),
                                  ),
                                ),
                            ...
                            Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Center(
                                    child: Image.asset("assets/images/bagde_debutant.png",scale: 9,),
                                  ),
                                  TextComponent(text: "Badge\ndébutant", fontWeight: FontWeight.bold,size: 12,textAlign: TextAlign.center,),
                                ],
                              ),
                            )
                          ],
