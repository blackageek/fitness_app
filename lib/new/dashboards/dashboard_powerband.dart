...
import '../presentation/presentationPowerBand.dart';
import '../presentation/presentationStepper.dart';
import '../programmeCardio/programme.dart';
import '../programmePowerBand/programme.dart';
...
import '../quizSeancePerso/powerbands.dart';
import '../seancePerso/powerband/seance_personnalise_programme_bbl.dart';
import '../seancePerso/powerband/seance_personnalise_programme_express.dart';
import '../seancePerso/powerband/seance_personnalise_programme_mix.dart';
import '../seancePerso/powerband/seance_personnalise_programme_power.dart';


class DashboardPowerband extends StatefulWidget {
  bool isLocked;
  DashboardPowerband({super.key, required this.isLocked});

  @override
  State<DashboardPowerband> createState() => _DashboardPowerbandState();
}

class _DashboardPowerbandState extends State<DashboardPowerband> {
  ...
  Future<void> _getProgressionGlobale() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    double? progression =
    powerbandProgram=="Programme Express"? prefs.getDouble('progressionGlobale_pgexpress_powerband') :
    powerbandProgram=="Programme Power"?  prefs.getDouble('progressionGlobale_pgpower_powerband'):
    powerbandProgram=="Programme BBL"?  prefs.getDouble('progressionGlobale_pgbbl_powerband'):
    prefs.getDouble('progressionGlobale_pgmix_powerband');
  ...
  void initState() {
    ...
    // poidCible_=double.parse(poidsCible)??0.0;
    _loadDaysStatus();
    jourSeance = '{${powerbanddays.split(',').map((j) => j.trim()).join(', ')}}';
              ...
              child: FadeInAnimation(
                child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    ...
                    Center(child: TextComponent(text: "Tableau de bord du Powerband",size: 15,fontWeight: FontWeight.bold,)),
                    ...
                    Column(spacing: 10,
                      children: [
                        Center(child: TextComponent(text: "Menu du Powerband", fontWeight: FontWeight.bold,size: 14,color: mainColor,)),
                        OwnDivider(),
                      ],
                    ),
                    h(10),
                    Center(
                      child: Wrap(
                        ...
                        children: [
                          InkWell(
                              onTap : (){
                                Navigator.push(context, MaterialPageRoute(builder: (context) => PresentationPowerBand(producName: "Le PowerBands", path: "power1.png")));
                              },
                              child: BoxProduitG("power1.png", "Présentations","Le PowerBands")),
                          InkWell(
                              onTap: () {
                                Navigator.push(context, MaterialPageRoute(builder: (context) => BibliothequePowerBands(isFromAccueil: false,)));
                              },
                              child: BoxProduitD("power2.png", "Exercices avec le PowerBands","Le PowerBands")),
                          InkWell(
                              onTap : (){
                                Navigator.push(context, MaterialPageRoute(builder: (context) => Programme(isLocked: false,)));
                              },
                              child: BoxProduitG("power3.png", "Programme d'entrainement","Le PowerBands")),
                          InkWell(
                              onTap : (){
                                Navigator.push(context, MaterialPageRoute(builder: (context) => PowerbandsForm()));
                              },
                              child: BoxProduitD("power4.png", "Séance Personnalisée","Le PowerBands")),
                        ],
                      ),
                    ),
                    ...
                    InkWell(
                      onTap: () {
                        ...
                        if (!joursSemaine.contains(today)) {
                          ...
                          powerbandProgram=="Programme Express"?PowerbandSeancePersonnaliseProgrammeExpress(isReturningFromDetails: false,joursSemaine: joursSemaine,):
                          powerbandProgram=="Programme Power"?PowerbandSeancePersonnaliseProgrammePower(isReturningFromDetails: false,joursSemaine: joursSemaine,):
                          powerbandProgram=="Programme BBL"?PowerbandSeancePersonnaliseProgrammeBBL(isReturningFromDetails: false,joursSemaine: joursSemaine,):
                          PowerbandSeancePersonnaliseProgrammeMix(isReturningFromDetails: false,joursSemaine: joursSemaine,)
                          ));
                        }
                      },
                      child: Card(
                                ...
                                Container(
                                  ...
                                  child:  Column(
                                    ...
                                    children: [
                                      ...
                                      TextComponent(text: powerbanddays, fontWeight: FontWeight.bold,size: 13,textAlign: TextAlign.center,color: mainColor,),
                                    ],
                                  ),
                                ),
                                Expanded(
