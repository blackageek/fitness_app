...
import '../seancePerso/stepper/seance_personnalise_programme_bbl.dart';
import '../seancePerso/stepper/seance_personnalise_programme_power.dart';


class DashboardStepper extends StatefulWidget {
  const DashboardStepper({super.key});

  @override
  State<DashboardStepper> createState() => _DashboardStepperState();
}

class _DashboardStepperState extends State<DashboardStepper> {
  ...
  Future<void> _getProgressionGlobale() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    double? progression = stepperProgram=="Programme BBL"? prefs.getDouble('progressionGprogressionGlobale_pgbbl_stepperlobale') :  prefs.getDouble('progressionGlobale_pgpower_stepper');
  ...
  void initState() {
    ...
    _loadDaysStatus();
    jourSeance = '{${stepperdays.split(',').map((j) => j.trim()).join(', ')}}';
              ...
              child: FadeInAnimation(
                child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    ...
                    Center(child: TextComponent(text: "Tableau de bord du Stepper",size: 15,fontWeight: FontWeight.bold,)),
                    ...
                    Column(spacing: 10,
                      children: [
                        Center(child: TextComponent(text: "Menu du Stepper", fontWeight: FontWeight.bold,size: 14,color: mainColor,)),
                        OwnDivider(),
                      ],
                    ),
                    h(10),
                    ...
                    Center(
                      child: Wrap(
                        ...
                        children: [
                          InkWell(
                              onTap : (){
                                Navigator.push(context, MaterialPageRoute(builder: (context) => PresentationStepper(producName: "Le Stepper", path: "stepper1.jpg")));
                              },
                              child: BoxProduitG("stepper1.jpg", "Présentations","Le Stepper")),
                          InkWell(
                              onTap: () {
                                Navigator.push(context, MaterialPageRoute(builder: (context) => BibliothequeStepper(isFromAccueil: false,)));
                              },
                              child: BoxProduitD("stepper2.png", "Exercices avec le Stepper","Le Stepper")),
                          InkWell(
                              onTap : (){
                                Navigator.push(context, MaterialPageRoute(builder: (context) => ProgrammeStepper(isLocked: false,)));
                              },
                              child: BoxProduitG("stepper3.png", "Programme d'entrainement","Le Stepper")),

                          InkWell(
                              onTap : (){
                                Navigator.push(context, MaterialPageRoute(builder: (context) => StepperForm()));
                              },
                              child:BoxProduitD("stepper4.png", "Séance Personnalisée","Le Stepper"),),
                        ],
                      ),
                    ),
                    ...
                    InkWell(
                      onTap: () {
                        ...
                        if (!joursSemaine.contains(today)) {
                          ...
                          stepperProgram=="Programme Power"? StepperSeancePersoProgrammePower(isReturningFromDetails: false,joursSemaine: joursSemaine,):
                          StepperSeancePersoProgrammeBBL(isReturningFromDetails: false,joursSemaine: joursSemaine,)
                          ));
                        }
                      },
                      child: Card(
                                ...
                                Container(
                                  ...
                                  child:  Column(
                                    ...
                                    children: [
                                      ...
                                      TextComponent(text: stepperdays, fontWeight: FontWeight.bold,size: 13,textAlign: TextAlign.center,color: mainColor,),
                                    ],
                                  ),
                                ),
                                Expanded(
