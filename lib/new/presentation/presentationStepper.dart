...
class PresentationStepper extends StatefulWidget {
  final String producName;
  final String path;

  PresentationStepper({super.key, required this.producName, required this.path});

  @override
  State<PresentationStepper> createState() => _PresentationStepperState();
}

class _PresentationStepperState extends State<PresentationStepper> {
  final List<String> videoUrls = [
    "https://www.youtube.com/watch?v=Yii7neVSZN8&list=PL27ZZQGb4Vdz4jlpuknSuJqtY3-S9CpsE&index=1&ab_channel=Gofitnext"
  ];
                  ...
                  child: Container(
                    ...
                    child: Center(
                      child: Container(
                          ...
                          child: TextComponent(text: "Stepper",fontWeight: FontWeight.bold,color: Colors.white,)),
                    ),
                  ),
                ),
              ],
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  Center(
                    child: TextComponent(
                      text: "Conseils d'utilisation Stepper",
                      fontWeight: FontWeight.bold,
                    ),
                  ),
                  YoutubePlayer(
