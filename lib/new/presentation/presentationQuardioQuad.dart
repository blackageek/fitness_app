...
class PresentationQuardioQuad extends StatefulWidget {
  final String producName;
  final String path;

  PresentationQuardioQuad({super.key, required this.producName, required this.path});

  @override
  State<PresentationQuardioQuad> createState() => _PresentationQuardioQuadState();
}

class _PresentationQuardioQuadState extends State<PresentationQuardioQuad> {
