...
class PowerSeancePerso extends StatefulWidget {
  final bool isReturningFromDetails;
  final List<String> joursSemaine;

  const PowerSeancePerso({
    super.key,
  ...
  @override
  State<PowerSeancePerso> createState() => _PowerSeancePersoState();
}

class _PowerSeancePersoState extends State<PowerSeancePerso> {
    ...
    allWeeksExercices = [
      ...
      [
        ...
        Exercice(
          ...
          repos: 75,
          linkVideo: "https://www.youtube.com/watch?v=0dms4paNPww&list=PL27ZZQGb4VdxSzlSFfgHSjFw-EIFmbomj&index=33&pp=iAQB",
        ),
        Exercice(
      ...
      [
        ...
        Exercice(
          ...
          repos: 60,
          linkVideo: "https://www.youtube.com/watch?v=lWXu8dKjIGk&list=PL27ZZQGb4VdxSzlSFfgHSjFw-EIFmbmbj&index=16&pp=iAQB",
        ),
      ],
      [
        Exercice(
...
// Modifiez _buildExerciseBox comme ceci :
  ...
  Future<void> _showStats(bool show) async {
    ...
    await prefs.setDouble('progressionGlobale_pgpower_powerfit', completionPercentage);
