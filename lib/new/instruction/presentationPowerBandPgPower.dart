...
class InstructionPowerBandPgPower extends StatefulWidget {
  final String producName;
  final String path;

  InstructionPowerBandPgPower({super.key, required this.producName, required this.path});

  @override
  State<InstructionPowerBandPgPower> createState() => _InstructionPowerBandPgPowerState();
}

class _InstructionPowerBandPgPowerState extends State<InstructionPowerBandPgPower> {
  late List<String> videoUrls = [
    "https://www.youtube.com/watch?v=dNZXI5fbTCo&list=PL27ZZQGb4VdwDWFyEY-XzzsEdVdyPHOCI&index=4&t=6s&pp=iAQB0gcJCYsJAYcqIYzv",
        "https://www.youtube.com/watch?v=MqkL22r8xgc&list=PL27ZZQGb4VdwDWFyEY-XzzsEdVdyPHOCI&index=1&pp=iAQB",
    "https://www.youtube.com/watch?v=J_zpHxK4nzE&list=PL27ZZQGb4VdwDWFyEY-XzzsEdVdyPHOCI&index=2&t=17s&pp=iAQB0gcJCYsJAYcqIYzv",
  ];
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  Center(
                    child: TextComponent(
                      text: "2- Explication exercice unilateral",
                      fontWeight: FontWeight.bold,
                    ),
                  ),
                  YoutubePlayer(
