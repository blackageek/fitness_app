...
class InstructionPowerBand extends StatefulWidget {
  final String producName;
  final String path;

  InstructionPowerBand({super.key, required this.producName, required this.path});

  @override
  State<InstructionPowerBand> createState() => _InstructionPowerBandState();
}

class _InstructionPowerBandState extends State<InstructionPowerBand> {
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                      Center(
                        child: TextComponent(
                          text: "2- Exercice explication unilatéral",
                          fontWeight: FontWeight.bold,
                        ),
                      ),
                    YoutubePlayer(
