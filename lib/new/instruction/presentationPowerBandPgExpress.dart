...
class InstructionPowerBandPgExpress extends StatefulWidget {
  final String producName;
  final String path;

  InstructionPowerBandPgExpress({super.key, required this.producName, required this.path});

  @override
  State<InstructionPowerBandPgExpress> createState() => _InstructionPowerBandPgExpressState();
}

class _InstructionPowerBandPgExpressState extends State<InstructionPowerBandPgExpress> {
