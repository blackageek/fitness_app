...
class PerteDePoidsHomme extends StatefulWidget {
  final bool isReturningFromDetails;
  List<String> joursSemaine;
  PerteDePoidsHomme({super.key, this.isReturningFromDetails = false, required this.joursSemaine});

  @override
  State<PerteDePoidsHomme> createState() => _PerteDePoidsHommeState();
}

class _PerteDePoidsHommeState extends State<PerteDePoidsHomme> {
